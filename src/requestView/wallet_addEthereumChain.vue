<template>
  <div class="request-mthod">
    ...
    <div class="content">
      创建一个确认消息，要求用户将指定的链添加到钱包应用。调用者必须指定链 ID
      和一些链元数据。由EIP-3085指定。
    </div>
    ...
    <div class="highlight-form">
      <el-form :model="form" label-width="auto" style="max-width: 600px">
        ...
        <el-form-item label="rpcUrls">
          <div v-for="(item, index) in form.rpcUrls" class="flex-between">
        ...
        <el-form-item label="iconUrls">
          <div v-for="(item, index) in form.iconUrls" class="flex-between">
            <el-input v-model="form.iconUrls[index]" />
            <div class="icon" @click="addProject('iconUrls')">+</div>
            <div
              v-if="index"
              class="icon"
        ...
        <el-form-item label="blockExplorerUrls">
          ...
          >
            ...
            <div class="icon" @click="addProject('blockExplorerUrls')">+</div>
            <div
              v-if="index"
              class="icon"
